...
// Function to change content of the checkout div
...
const cart = () => {
    ...
    const addCartToHTML = () => {
        ...
        listCartHTML.innerHTML += `<div class="total">
        <hr>
        <div class="totalValue"><span>Sub Total:</span><span>$${totalPrice}</span></div>
        <div class="totalValue"><span>Delivery Fees:</span><span>$${fees}</span></div>
        <div class="totalValue"><span>Total:</span><span>$${totalPrice + fees}</span></div>

        <p>Notice: <br> Scroll down to Submit your data & Checkout!</p>
        </div>`;
    };
...
export default cart;
// Export the changeText function
